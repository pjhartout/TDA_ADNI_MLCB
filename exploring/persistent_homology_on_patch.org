...
patch_cn_binarized, patch_cn = utils.prepare_image("../data/cropped/sub-ADNI002S0295-M00-MNI.npy", 0.5)
patch_ad_binarized, patch_ad = utils.prepare_image("../data/cropped/sub-ADNI002S0729-M48-MNI.npy", 0.5)
diagrams_cp_cn = utils.cubical_persistence(patch_cn, "CN patch patient", plot_diagrams=False, betti_curves=False)
diagrams_cp_ad = utils.cubical_persistence(patch_ad, "AD patch patient", plot_diagrams=False, betti_curves=False)
#+END_SRC
...
X_distance_L = PD.fit_transform(np.asarray([diagrams_cp_cn, diagrams_ad_cn]))
plot_heatmap(X_distance_L, colorscale='blues').show()
#+END_SRC
