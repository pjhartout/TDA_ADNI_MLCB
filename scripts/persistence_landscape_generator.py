...
"""persistence_landscape_generator.py

This script generates the persistence for a given array, which represents
...
def main():
    ...
    persistence_images = get_persistence_landscape(persistence_diagrams)

    export_persistence_images(
        persistence_images, files_loaded, path_to_persistence_landscape
    )
